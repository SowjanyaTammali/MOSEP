...
node_df = pd.read_csv("/Users/stb34/Documents/wildfire/Experiments/Seattle/final_node_zone_classification_median_seeded.csv")
...
# === Step 7: Save to CSV ===
final_df.to_csv("/Users/stb34/Documents/wildfire/Experiments/Seattle/final_edge_weights_with_virtual_exit.csv", index=False)
