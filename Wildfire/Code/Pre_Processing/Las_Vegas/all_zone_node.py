...
sf_df = pd.read_csv("/Users/stb34/Documents/wildfire/Experiments/Las_Vegas/Las_Vegas_link.csv")
zone3_df = pd.read_csv("/Users/stb34/Documents/wildfire/Experiments/Las_Vegas/zone3_data.csv")
...
# === Step 4: Define ROS values to randomly choose from ===
...
nonzone3_df["zone"] = nonzone3_df["fire_prob"].apply(lambda p: 2 if p > 0.0 else 1)


# === Step 8: Combine and save ===
final_df = pd.concat([pd.DataFrame(zone3_results), nonzone3_df], ignore_index=True)
output_path = "/Users/stb34/Documents/wildfire/Experiments/Las_Vegas/final_node_zone_classification_median_seeded.csv"
